...
{/*second-page*/}
    ...
    <div class="third-page">
      <div class="third-page1">
        <div class="third-box">
          <img width="450px" class="third-img1" src={IMAGES.THIRDIMGONE} alt="" />
        ...
        <div class="third-page2">
          <img width="450px" class="third-img2" src={IMAGES.THIRDIMGTWO} alt="" />
        ...
        <div class="third-page3">
          <img width="450px" class="third-img3" src={IMAGES.THIRDIMGTHREE} alt="" />
        ...
        <div class="third-page4">
          <img width="450px" class="third-img4" src={IMAGES.THIRDIMGFOUR} alt="" />
        ...
        <div class="third-page5">
          <img width="450px" class="third-img5" src={IMAGES.THIRDIMGFIVE} alt="" />
        ...
        <div class="third-page6">
          <img width="450px" class="third-img6" src={IMAGES.THIRDIMGSIX} alt="" />
...
<li>TikTok Video Editor</li>
    ...
    <div class="ninth-con2">
      ...
      <div class="nin-box7">
        ...
        <img width="250px" src={IMAGES.NINETHIMGSIX} alt=""/>
      </div>
    </div>
  </div>
</div>
